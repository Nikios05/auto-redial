Основное задание: сверстать страницу, с требованием кроссбраузерности (последние версии Chrome, Mozilla, Opera, Edge) и валидности

Дополнительное задание: полное соответствие нашим внутренним стандартам

Методика написания HTML https://ru.bem.info/methodology/html/
Методика написания CSS https://ru.bem.info/methodology/css/
 
Основные требования:
Соответствие макету (Pixel Perfect)
Кроссбраузерность (последние версии Chrome, Mozilla, Opera, Edge).
...
Раскладка блоков на странице сделана с помощью flexbox(без float,inline-block) или grid.
...
Удалены лишние стили, неиспользуемые в проекте.

Шрифты
Подключённые шрифты, их размеры и жирность соответствуют размерам в макетах.
